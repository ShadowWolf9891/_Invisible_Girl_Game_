...
//TODO: Look into Bresenhamfs Line genration.
std::vector<sf::Vector2f> Raycast::BuildLinePoints(const sf::Vector2f& from, const sf::Vector2f& to)
{
    // TODO: it would be preferable to calculate in advance the size of "result" and to use a fixed-size array instead of a list.
